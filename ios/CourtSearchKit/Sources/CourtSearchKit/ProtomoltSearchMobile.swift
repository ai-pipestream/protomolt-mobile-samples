// Vendored verbatim from ai-pipestream/protomolt-search mobile/apple/ProtomoltSearch.swift
// (MIT) at the revision in Generated/ENGINE_REV. The engine ships this file beside
// the XCFramework as its optional Data facade; it is not part of the binary.
